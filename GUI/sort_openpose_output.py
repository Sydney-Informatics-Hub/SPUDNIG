...
def sort_openpose(root):
    ...
    # Use forward slashes for Linux file paths
    hand_left_csv.to_csv(os.path.join(root, 'hand_left_sample.csv'), encoding='utf-8', index=False, header=None)
    hand_right_csv.to_csv(os.path.join(root, 'hand_right_sample.csv'), encoding='utf-8', index=False, header=None)
    pose_csv.to_csv(os.path.join(root, 'sample.csv'), encoding='utf-8', index=False, header=None)
